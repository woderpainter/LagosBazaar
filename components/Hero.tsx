...
export const Hero: React.FC = () => {
  ...
  return (
    <div className="relative bg-primary overflow-hidden">
        ...
        <div className="relative z-10 pb-8 bg-primary sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
          <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              <h1 className="text-4xl tracking-tight font-extrabold text-surface sm:text-5xl md:text-6xl">
                <span className="block xl:inline">Welcome to</span>{' '}
                <span className="block text-accent xl:inline">LagosBazaar.</span>
              </h1>
              <p className="mt-3 text-base text-green-50 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
              ...
              <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                <div className="rounded-md shadow">
                  <a href="#featured" className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-primary bg-surface hover:bg-gray-50 md:py-4 md:text-lg">
                    Shop Now
                  </a>
                </div>
                <div className="mt-3 sm:mt-0 sm:ml-3">
                  <a href="#" className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-surface bg-primary-dark hover:bg-opacity-90 md:py-4 md:text-lg">
      ...
      <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 bg-primary-dark relative">
        {loading && (
            <div className="absolute inset-0 flex items-center justify-center text-surface space-x-2">
                <Sparkles className="animate-spin h-6 w-6 text-accent" />
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-primary via-primary/50 to-transparent lg:via-transparent"></div>
      </div>
    </div>
  );
};